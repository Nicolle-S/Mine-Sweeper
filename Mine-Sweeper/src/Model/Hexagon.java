...
/**
 *Contiene la logica usada en el tablero de forma hexagonal, aqui se implementan
 * los metodos absatractos especificos para este tipo de tablero
 */
            ...
            for (int j = 0; j < N_COLS; j++) {
                ...
                if(table[i][j] == 9){
                    ...
                    */
                    ...
                    /**
                    * si estoy en una fila IMPAR debo verificar ademas las diagonales derechas
                    */
                    if( (i % 2) != 0 ){
                    ...
                    /**
                     * De otro modo verifico las diagonales izquierdas
                     */
                    else{
